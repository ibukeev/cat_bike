...
HERE = ROOT / "hardware/mechanical/fabrication/3d-print/cat-head-full-size-v1/source/cad-change-control/review-only/right-eye-aperture-fitted-led-cassette-review-v2"
CONTRACT = json.loads((HERE / "contract.json").read_text(encoding="utf-8"))
SOURCE = (HERE / "generate_review.py").read_text(encoding="utf-8")


class ApertureFittedLedCassetteReviewTests(unittest.TestCase):
    ...
    def test_front_is_inset_and_has_no_surface_flange(self) -> None:
        ...
        self.assertGreaterEqual(CONTRACT["dimensions_mm"]["visible_aperture_radial_inset"], 3.4)
