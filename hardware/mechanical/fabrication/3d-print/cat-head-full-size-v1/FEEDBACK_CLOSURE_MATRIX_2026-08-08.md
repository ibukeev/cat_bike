...
| F-10 | V10/A-B uses seated datums and separated retention points. | Layout accepted; right A/B production hold. | Approve B relief and A hardware; integrate right side only. |
...
1. Review the existing right-B relief and right-A short-insert contract.
2. After approval, integrate only right A/B and rerun topology, clearance,
