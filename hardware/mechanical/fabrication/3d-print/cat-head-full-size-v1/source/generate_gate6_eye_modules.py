...
def main() -> None:
    ...
    acceptance = {
        ...
        "all_eye_parts_single_connected_body": topology_policy.all_single_closed_bodies(
            all_part_metrics
        ),
        ...
        "all_gate6_shells_single_connected_body": topology_policy.all_single_closed_bodies(
