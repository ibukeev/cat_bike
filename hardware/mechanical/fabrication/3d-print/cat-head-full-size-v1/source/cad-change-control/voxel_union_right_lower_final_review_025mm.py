"""Voxel-union the final right-lower review input into one STL artifact."""
...
OUTPUT_STL = os.path.join(OUTPUT_DIR, "right-lower-final-review-voxel-union-025mm.stl")
VOXEL_SIZE_MM = 0.25

if not os.path.isfile(INPUT_STL):
    raise RuntimeError("Missing FreeCAD export: " + INPUT_STL)
...
print("EXPORTED FINAL-REVIEW STL:", OUTPUT_STL)
