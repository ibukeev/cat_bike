"""Write a manifold/connectivity report for the final right-lower review STL."""
...
INPUT_STL = os.path.join(OUTPUT_DIR, "right-lower-final-review-voxel-union-025mm.stl")
...
if len(objects) != 1:
    raise RuntimeError("Expected one imported mesh object, got %d" % len(objects))
