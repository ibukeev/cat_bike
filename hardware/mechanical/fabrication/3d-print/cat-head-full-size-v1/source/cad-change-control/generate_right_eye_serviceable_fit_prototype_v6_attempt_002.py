#!/usr/bin/env python3
"""Generate attempt-002 of the unchanged V6 serviceable-fit right eye.

This is a new construction lineage.  It does not import, call, inspect, or
reuse the V1/V3 generator, any V1/V3 candidate, or any quarantined V4/V5/V6
FCStd.  The eye is reconstructed from the protected aperture/LCS, the numeric
V5/V17 mount datums, and the unchanged V6 serviceability contract.
...
import validate_right_eye_serviceable_fit_previsual_v6_attempt_002 as design_control
...
def immutable_preflight(
    ...
    *,
    ...
    shared_validator = import_pinned_module(
        ...
        "cat_head_shared_v2_validator_for_eye_v6_attempt_002",
    )
...
def in_memory_finalization_preflight(context: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "status": "IN_MEMORY_FINALIZATION_PASS__ATTEMPT_002_READY",
        "iteration_id": ITERATION_ID,
        "design_id": DESIGN_ID,
