...
**Next active work:** `HS-11`. V11 preserves the user-accepted V10 actual
...
interference. V11 awaits visual approval. The inherited revised lower-face mesh
...
| HS-11 | [ ] | Integrate and validate all eight eye flanges | Right locations, C046/C048 V2, and the V10 actual-neck deletion were visually approved separately. V11 combines those exact accepted states without moving the eye or four flanges: C046/C048 clearance is `4.6063/4.0317 mm`, both pair gaps are `0.3000 mm`, and the stale original ribs are absent. The revised lower-face review mesh is not yet a watertight FreeCAD solid. | Visually approve V11, repair the inherited lower-face topology without changing its exterior, integrate copied owners, revalidate hardware/clearance/exterior, mirror exactly, and repeat bilaterally. |
