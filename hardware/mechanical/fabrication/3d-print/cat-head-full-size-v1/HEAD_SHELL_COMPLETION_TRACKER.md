...
`4.0 mm` offset at either tested tolerance. V31 then closed the rigid rail
route: the exact V26 tapered rail has zero clean translation candidates.
...
V33 now implements that exact translation in a review-only one-sided FreeCAD
preview. It adds zero support geometry, reproduces the V32 clearance and
engagement, keeps C009 as one valid closed `38`-face solid, and has zero
collision with the other 40 upper components. Visual acceptance of the orange
moved C009 is still required. The separate non-visible C001 correction remains
...
- [C009 reposition preview V33 checkpoint](RIGHT_UPPER_C009_REPOSITION_PREVIEW_V33_CHECKPOINT_2026-08-16.md)
...
- [Rejected bilateral lower-face exact-mirror V15 checkpoint](LOWER_FACE_BILATERAL_EXACT_MIRROR_REVIEW_V15_CHECKPOINT_2026-08-14.md)
- [Current right-eye flange owner-integration V16 checkpoint](RIGHT_EYE_FLANGE_OWNER_INTEGRATION_REVIEW_V16_CHECKPOINT_2026-08-14.md)
- [Current right-eye exact owner-integration V17 checkpoint](RIGHT_EYE_EXACT_OWNER_INTEGRATION_REVIEW_V17_CHECKPOINT_2026-08-14.md)
...
- [C001/C009 existing-body route audit V29 checkpoint](RIGHT_UPPER_C001_C009_EXISTING_BODY_ROUTE_AUDIT_V29_CHECKPOINT_2026-08-16.md)
