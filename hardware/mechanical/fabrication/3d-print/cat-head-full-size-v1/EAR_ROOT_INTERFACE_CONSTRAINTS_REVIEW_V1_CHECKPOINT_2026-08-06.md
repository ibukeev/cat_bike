...
This completed read-only constraints review is archived. It isolated the exact
Gate 8 ear shells, upper-head owners, integrated four-M3 saddles, and rejected
ear-root glow inserts without changing mesh geometry.

The large-relief ear-root insert variant is rejected because it leaves missing
coverage beneath the ears. The replacement geometry is now in the V2 restored-
coverage review.

## Primary review files

- Blender: `output/60-ear-root-reviews/ear-root-interface-constraints-review-v1/ear-root-interface-constraints-review-v1.blend`
- Validation: `output/60-ear-root-reviews/ear-root-interface-constraints-review-v1/ear-root-interface-constraints-review-v1-validation.json`
- Renders: `output/60-ear-root-reviews/ear-root-interface-constraints-review-v1/renders/`
...
Completed by `ear-root-restored-coverage-review-v2.blend`. The V2 candidate
restores the missing coverage with a mirrored `13/9 mm` localized relief,
preserves the four-M3 saddle and independent ear removal, and remains a
review-only mesh with no STL or print release.
