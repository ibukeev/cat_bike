...
- Primary LED system is 5 V addressable LEDs.
...
| Cat head reserved branch | 18 AWG | Future head, eyes, and fiber-whisker light engines. |
...
| B4 | Cat head reserved | Phase 2A | Reserved | Reserved | May be separate from fork/front if cleaner. |
...
- Candidate removable LED branch connectors:
  ...
  - M8/M12 waterproof circular connectors for more robust removable modules.
...
- Choose exact connector family for removable LED branches.
